...
// Prereq: s is a string.
     ...
     * that the URLs used for sourcing Angular templates are safe.
     * Refer {@link ng.$sceDelegateProvider#resourceUrlWhitelist $sceDelegateProvider.resourceUrlWhitelist} and
 ...
 *      });
     ...
     * $sce.getTrusted(context, value)} rather than to the value directly.  Directives use {@link ng.$sce#parse $sce.parseAs} rather than `$parse` to watch attribute bindings, which performs the
 ...
 *   }];
     ...
     * served document.  You can change these by setting your own custom {@link ng.$sceDelegateProvider#resourceUrlWhitelist
     * whitelists} and {@link ng.$sceDelegateProvider#resourceUrlBlacklist blacklists} for matching such URLs.
     *
 ...
 *     });
     ...
     * {@link ngSanitize.$sanitize $sanitize} service.  To utilize this functionality, ensure that `$sanitize`
 ...
 * }
     ...
     * {@link ng.$sce#trustAsResourceUrl wrap them} as trusted values. Refer to Angular's {@link ng.$sce Strict Contextual Escaping}.
     *
